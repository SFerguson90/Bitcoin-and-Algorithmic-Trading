...
class SMABacktester(object):
    ...
    def update_and_run(self, SMA):
        ...
        '''
        Updates the SMA parameters and returns negative absolute performance
    ...
    def optimize_parameters(self, SMA1_range, SMA2_range):
        ...
        '''
        Finds the global maximum given the SMA parameter ranges.
...
if __name__ == '__main__':
    SPY = SMABacktester("SPY", 20, 150,
                         "2018-01-01", "2020-01-01")
    print(SPY.run_strategy())
    print(SPY.optimize_parameters((20, 60, 1), (100, 200, 1)))
    SPY.set_parameters(SMA1=35, SMA2=123)
    print(SPY.run_strategy())
    SPY.plot_results()